<template>
  <a-form :model="formState" :rules="rules" @finish="onSubmit">
    ...
    <div class="flex gap-2">
      <a-form-item name="cellphone" class="w-full">
        <r-input v-model:value="formState.cellphone" placeholder="Cell phone Number" />
      </a-form-item>
      <r-button
        title="Send"
        type="primary"
...
const rules = reactive({
  ...
  cellphone: [{ validator: validateRequired, trigger: 'change' }],
